...
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$CPJ8qtmypyCLiEN/5+w2dA$OjyHiVlk6Yc+G2Nfufh2YlDxVBHSrjQ/9VCv3QGVBk4'
...
#  Choices: any of ['sha256', 'blake2s', 'sha3_256', 'sha512', 'sha3_224', 'md5', 'blake2b', 'sha384', 'sha3_384', 'sha1', 'sha3_512', 'sha224']
#  Default: 'sha256'
